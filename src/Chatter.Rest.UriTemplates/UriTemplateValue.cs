...
public abstract class UriTemplateValue
{
    ...
    public static UriTemplateValue FromString(string value) => new StringValue(value);
    ...
    public static UriTemplateValue FromList(IEnumerable<string> values) => new ListValue(values);
    ...
    public static UriTemplateValue FromDictionary(IDictionary<string, string> pairs) => new DictionaryValue(pairs);
